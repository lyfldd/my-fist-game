...
{
    /// <summary>
    /// 用电终端面板 UI。静态方法 Show/Hide，UGUI/IMGUI 双模式。
    /// </summary>
    public class TerminalUI : MonoBehaviour
    {
        ...
        void InitStyles()
        {
            ...
            _stylesInit = true;
            _headerStyle = new GUIStyle(GUI.skin.label) { fontSize = 18, fontStyle = FontStyle.Bold, alignment = TextAnchor.MiddleCenter, normal = { textColor = Color.white } };
            _normalStyle = new GUIStyle(GUI.skin.label) { fontSize = 14, normal = { textColor = Color.white } };
